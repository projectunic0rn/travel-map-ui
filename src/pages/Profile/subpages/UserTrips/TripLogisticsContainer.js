...
import TransportationIconContainer from "../Cities/TransportationIconContainer";
...
function TripLogisticsContainer({ reviews, city, urlUsername, refetch }) {
...
export default TripLogisticsContainer;
